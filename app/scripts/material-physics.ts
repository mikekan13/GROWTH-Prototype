...
const CALIBRATION: Mat[] = [
  ...
  { name: 'Brick (fired clay)', cls: 'mineral', tensile: 2.8, compressive: 35, kic: 1.0, u: 0.01, elong: 0.2, mohs: 3.5, density: 1.9, canon: 20, traitNote: 'computed ~4 vs canon 20: canon prices DEPLOYED masonry (mortared wall mass), not a hand sample — a single brick snaps under a hammer tap. Structure/form factor, flag for item-level handling', cite: 'fired clay brick: compressive 20-80 MPa, tensile ~2-4' },
  { name: 'Concrete (cured, normal)', cls: 'mineral', tensile: 3.5, compressive: 35, kic: 1.2, u: 0.015, elong: 0.15, mohs: 4, density: 2.4, canon: 25, traitNote: 'computed ~6 vs canon 25: same deployed-mass story as brick, plus rebar partnership assumed in modern use (stock also sells Rebar 30 separately). Canon Strong trait + structure form factor carries it', cite: 'normal concrete: f\'c 30-40 MPa, tensile 3-5, K_IC 0.8-1.4' },
