...
const DEMO_CHARACTER: GrowthCharacter = {
  ...
  skills: [
    { name: 'Herbalism', level: 12, governors: ['wisdom', 'focus'] as const, description: 'Identify and prepare botanical remedies' },
    { name: 'Short Blade', level: 7, governors: ['celerity', 'clout'] as const },
    { name: 'Persuasion', level: 5, governors: ['wit', 'willpower'] as const },
    { name: 'Occult Lore', level: 9, governors: ['wisdom', 'focus'] as const, description: 'Knowledge of supernatural phenomena and fiend heritage' },
    { name: 'Alchemy', level: 10, governors: ['wisdom', 'focus'] as const, description: 'Transmutation and potion brewing' },
    { name: 'Stealth', level: 4, governors: ['celerity'] as const },
    { name: 'Dodge', level: 6, governors: ['celerity'] as const },
    { name: 'Intimidation', level: 3, governors: ['willpower', 'clout'] as const, description: 'The fiend eyes help' },
    { name: 'Environmental Awareness', level: 8, governors: ['wisdom', 'wit'] as const },
    { name: 'Medicine', level: 11, governors: ['wisdom', 'focus'] as const, description: 'Diagnosis and treatment of illness and injury' },
  ],
  magic: {
    mercy: {
