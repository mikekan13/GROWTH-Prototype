...
| /api/characters/[id]/daya/converse | POST | daya/conversation converseWithEntity (the 1:1 talk surface — stimulus in, Say:/Do:/Attend:/Rest out, or a graceful disabled/dormant/core_offline status, GM/ADMIN-only) |
