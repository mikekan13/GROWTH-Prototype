...
| FrequencyService | `services/frequency.ts` | Spend and restore Frequency (non-burn ops). Spend permanently reduces MAX; restore adds back up to max. Triggers death save when hitting 0 | character-actions, death-save, Prisma |
