...
- **Tools** (16 files in `ai/copilot/tools/`): actors, attribute-set, cast (preview_cast + resolve_cast — casting co-pilot per r-2026-07-22-01; canon summary rides the tool descriptions), condition, damage, forge-blueprint, list-canvas-characters, memory, mistake-corpus, move-character, npc-speak, place-on-canvas, remove-from-canvas, time, time-metrics.
