...
const WF = 'C:/Projects/GRO.WTH/standalone/src/ai/portraits/workflows/character-face-ipadapter-fast.json';
...
wf['7'].inputs.seed = 888;
// force CPU provider + 768 for 8GB compat
wf['30'].inputs.provider = 'cpu';
wf['6'].inputs.width = 768;
